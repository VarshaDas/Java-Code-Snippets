...
//
//
//        //GROUP by DEPT and find max salary
...
//                .collect(Collectors.toList());
//
//        //Find frequency of every character in a string
//
//        String name = "Varsha";
//
...
//        String inputString = "ilovecoding";
//
//        Map<Character, Long> charCountMap = inputString.chars()
//                .mapToObj(c -> (char) c)
//                .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
//
//        // Step 5: Filter the Map to keep only the characters with occurrence count greater than 1 (duplicates).
...
//        Map<Character, Integer> UniquecharCountMap = new LinkedHashMap<>();
//
//        // Iterate through the characters and count their occurrences.
//        for (char c : inputString.toCharArray()) {
//            UniquecharCountMap.put(c, UniquecharCountMap.getOrDefault(c, 0) + 1);
//        }
//
//        Character character = inputString.chars().mapToObj(c -> (char) c).filter(e -> UniquecharCountMap.get(e) == 1).findFirst().get();
//        System.out.println(character);
//
//
//        //find second highest number
//        int[] arr = {2,3,8,9,10,21,12};
//        int maxTotal = Arrays.stream(arr).max().orElse(Integer.MIN_VALUE);
//
//        // Find the second highest number by excluding the maximum value.
